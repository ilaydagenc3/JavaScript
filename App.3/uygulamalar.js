...
//         if(urun.isim.toLocaleUpperCase().includes(kullaniciUrunIsmi.toLocaleUpperCase(),0)) {
...
// let kitap2 = {isim : "Hİçbir Karşılaşma Tesadüf Değildir",yazar : "Hakan Mengüç",fiyat : 56,
// raf : "2.3.RAF"}
...
// raf : "4.1.RAF"}
// let kitap5 = {isim : "Şeker Portakalı",yazar : "José Mauro de Vasconcelos",fiyat : 22,
// raf : "5.3.RAF"}
...
// let kitapIsmi = prompt("lütfen bir kitap ismi girin");
...
//     rafOlustur();
// }else{
//     alert("girdiğiniz kitap bulunmuyor");
// }